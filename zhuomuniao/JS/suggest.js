...
define(function(require,exports,module){
	...
	Suggest.prototype = {
				 ...
				 keyup:function(evt){
				 	...
				 	switch(evt.keyCode){
				 		...
				 		case 13:  //回车键
				 			...
				 			break;
				 		default:  //其他输入键
				 			var key = that.getTargetValue($(this));
		...
		getTriggerEl:function($el){
			return $el.closest('[data-search]').find('[data-sugggest-trigger]');
		}
		...
		getDom:function($el){
			return{
				...
				suggestTrigger:$el.find('[data-suggest-strigger]'),
				suggestPanel:$el.find('[data-sugggest-result]'),
				clearTestBtn:$el.find('[data-clear-btn]')
			};
		}
	};
	return Suggest;
